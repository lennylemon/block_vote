/* an implementation of a voting system based on blockchain, simply to learn something about the process and use some datastructures. 17/08/20 */
...
void main(int argc, char const **argv){
	...
	// adding random votes to show method
